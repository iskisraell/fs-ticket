...
export const ABRIGO_CHECKLIST_TEMPLATE: ChecklistGroup[] = [
    {
        title: 'Cobertura',
        items: [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'ESTRUTURA_BANCO_PICHADO', label: 'Banco Pichado', value: false },
            ...
            { key: 'ESTRUTURA_COLAGEM', label: 'Colagem', value: false },
            ...
            { key: 'ESTRUTURA_SUJO', label: 'Sujo', value: false },
    ...
    },
    {
        title: 'Itinerário',
        items: [
            { key: 'ITINERARIO_AUSENTE', label: 'Ausente', value: false },
...
export const TOTEM_CHECKLIST_TEMPLATE: ChecklistGroup[] = [
    {
